...
# (a) ==========================================================================
weeksm_lm <- lm(fertility$weeksm1 ~ 1 + fertility$morekids)
summary(weeksm_lm)
...
# children being same sex not having has a third child is 47.83%. There is a 
# 7.16% difference between these two likelihoods, this effect is relatively large.
...
# morekids because samesex has an effect on morekids, however, it does not have a
# direct effect on weeksworked. Therefore cov(samesex, morekids) =/= 0
